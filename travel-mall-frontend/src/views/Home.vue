...
<template>
  <div class="home" id="home" name="home">
    ...
    <div class="main-box">
      <div class="main">
        <!-- 秒杀商品展示区域 -->
        <div class="accessory" id="seckill-menu">
          <div class="box-hd">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <ul>
                <li>
                  <img :src="$target +'public/imgs/accessory/accessory-promo3.png'" alt />
                </li>
              </ul>
            </div>
            <div class="list">
              <SeckillList  :list="seckillList" :isMore="false" :showLength="4"></SeckillList>
            </div>
          </div>
        </div>
        <!-- 秒杀商品展示区域END -->
        ...
        <div class="phone">
          ...
          <div class="box-bd">
            ...
            <div class="list">
              <MyList :list="phoneList" :isMore="true" :showLength="7"></MyList>
            </div>
          </div>
        </div>
        <!-- 手机商品展示区域END -->
        ...
        <!-- 家电商品展示区域 -->
        <div class="appliance" id="HEA-menu">
          <div class="box-hd">
            <div class="title">家电</div>
            <div class="more" id="HEAmore">
          ...
          <div class="box-bd">
            ...
            <div class="list">
              <MyList :list="applianceList" :isMore="true" :showLength="7"></MyList>
            </div>
          </div>
        </div>
        <!-- 家电商品展示区域END -->
        ...
        <!-- 配件商品展示区域 -->
        <div class="accessory" id="part-menu">
          <div class="box-hd">
            <div class="title">配件</div>
            <div class="more" id="part-more">
          ...
          <div class="box-bd">
            ...
            <div class="list">
              <MyList :list="accessoryList" :isMore="true" :showLength="7"></MyList>
            </div>
          </div>
        </div>
        <!-- 配件商品展示区域END -->
...
export default {
  ...
  created() {
    // 获取轮播图数据
    this.$axios
      .post("resources/carousel",{withCredentials : true})
      .then(res => {
    ...
    this.getSeckill("小米秒杀","seckillList");
  ...
  methods: {
    ...
    // 获取秒杀商品数据方法封装
    getSeckill(categoryName,val, api) {
      api = api != undefined ? api : "seckill/getSecGoods";
      this.$axios
          .post(api,{withCredentials : true})
          .then(res => {
            this[val] = res.data.secGoods;
          })
          .catch(err => {
            return Promise.reject(err);
          });
